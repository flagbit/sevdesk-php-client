# flagbit\sevdesk\phpclient\AssetPosApi
...
# **addAssetPos**
> \flagbit\sevdesk\phpclient\Model\ModelAssetPos addAssetPos($body)
...
$api_instance = new flagbit\sevdesk\phpclient\Api\AssetPosApi();
...
[**\flagbit\sevdesk\phpclient\Model\ModelAssetPos**](../Model/ModelAssetPos.md)
...
# **getAssetPositions**
> \flagbit\sevdesk\phpclient\Model\ModelAssetPos getAssetPositions($limit, $offset, $embed)
...
# **updateAssetPosition**
> \flagbit\sevdesk\phpclient\Model\ModelAssetPos updateAssetPosition($id, $body)
