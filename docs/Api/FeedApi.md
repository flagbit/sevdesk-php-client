# flagbit\sevdesk\phpclient\FeedApi
...
# **addFeed**
> \flagbit\sevdesk\phpclient\Model\ModelFeed addFeed($body)
...
$api_instance = new flagbit\sevdesk\phpclient\Api\FeedApi();
...
# **getFeeds**
> \flagbit\sevdesk\phpclient\Model\ModelFeed getFeeds($limit, $offset, $embed)
...
# **updateFeed**
> \flagbit\sevdesk\phpclient\Model\ModelFeed updateFeed($id, $body)
