# flagbit\sevdesk\phpclient\InvoicePosApi
...
# **addInvoicePos**
> \flagbit\sevdesk\phpclient\Model\ModelInvoicePos addInvoicePos($body)
...
$api_instance = new flagbit\sevdesk\phpclient\Api\InvoicePosApi();
...
# **getInvoicePositions**
> \flagbit\sevdesk\phpclient\Model\ModelInvoicePos getInvoicePositions($limit, $offset, $embed)
...
# **updateInvoicePos**
> \flagbit\sevdesk\phpclient\Model\ModelInvoicePos updateInvoicePos($id, $body)
