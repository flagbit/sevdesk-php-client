# flagbit\sevdesk\phpclient\VoucherApi
...
# **addVoucher**
> \flagbit\sevdesk\phpclient\Model\ModelVoucher addVoucher($body)
...
$api_instance = new flagbit\sevdesk\phpclient\Api\VoucherApi();
...
# **getVouchers**
> \flagbit\sevdesk\phpclient\Model\ModelVoucher getVouchers($limit, $offset, $embed)
...
# **saveVoucher**
> \flagbit\sevdesk\phpclient\Model\ModelVoucherFactory saveVoucher($body)
...
[**\flagbit\sevdesk\phpclient\Model\ModelVoucherFactory**](../Model/ModelVoucherFactory.md)
...
# **updateVoucher**
> \flagbit\sevdesk\phpclient\Model\ModelVoucher updateVoucher($id, $body)
...
> \flagbit\sevdesk\phpclient\Model\ModelAccountingType voucherGetAccountingTypes($id, $embed)
...
> \flagbit\sevdesk\phpclient\Model\ModelVoucher voucherGetDependingRecurringVouchers($id, $embed)
...
# **voucherMarkAsOpen**
> \flagbit\sevdesk\phpclient\Model\ModelVoucher voucherMarkAsOpen($id)
...
# **voucherMarkAsPaid**
> \flagbit\sevdesk\phpclient\Model\ModelVoucher voucherMarkAsPaid($id, $body)
...
# **voucherRefundAmount**
> \flagbit\sevdesk\phpclient\Model\ModelVoucherLog voucherRefundAmount($id, $body)
...
> \flagbit\sevdesk\phpclient\Model\ModelVoucherFactory voucherUploadTempFile($file)
