...
**_contact** | [**\flagbit\sevdesk\phpclient\Model\ModelContact**](ModelContact.md) | the Model_Contact which is linked to the order | [optional] 
...
**_create_user** | [**\flagbit\sevdesk\phpclient\Model\ModelSevUser**](ModelSevUser.md) |  | [optional] 
...
**_contact_person** | [**\flagbit\sevdesk\phpclient\Model\ModelSevUser**](ModelSevUser.md) | contact person for the order which is a SevUser | [optional] 
...
**_address_contact_ref** | [**\flagbit\sevdesk\phpclient\Model\ModelContactAddress**](ModelContactAddress.md) |  | [optional] 
...
**_address** | [**\flagbit\sevdesk\phpclient\Model\ModelContactAddress**](ModelContactAddress.md) | concatenation of address attributes acquired from Model_Contact-&gt;Model_ContactAddress | [optional] 
