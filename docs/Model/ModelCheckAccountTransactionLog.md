...
**_check_account_transaction** | [**\flagbit\sevdesk\phpclient\Model\ModelCheckAccountTransaction**](ModelCheckAccountTransaction.md) | the check account transaction to which the log refers | [optional] 
