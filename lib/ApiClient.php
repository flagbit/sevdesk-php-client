...
class ApiClient
{
     ...
     */
    public function __construct(\flagbit\sevdesk\phpclient\Configuration $config = null)
    {
        if ($config === null) {
     ...
     *
     * @throws \flagbit\sevdesk\phpclient\ApiException on a non 2xx response
     * @return mixed
     */
    public function callApi($resourcePath, $method, $queryParams, $postData, $headerParams, $responseType = null, $endpointPath = null)
    {
        ...
        if ((is_array($postData) || is_object($postData)) and in_array('Content-Type: application/x-www-form-urlencoded', $headers, true)) {
            ...
            $postData = json_encode(\flagbit\sevdesk\phpclient\ObjectSerializer::sanitizeForSerialization($postData));
        }
