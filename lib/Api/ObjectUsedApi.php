...
class ObjectUsedApi
{
     ...
     * @return \flagbit\sevdesk\phpclient\Model\ModelObjectUsed
     */
     ...
     * @param int $offset Set the index where the returned objects used start. Default is 0 (optional, default to 0)
     * @throws \flagbit\sevdesk\phpclient\ApiException on non-2xx response
     * @return array of \flagbit\sevdesk\phpclient\Model\ModelObjectUsed, HTTP status code, HTTP response headers (array of strings)
     */
    public function getObjectUsedWithHttpInfo($limit = '100', $offset = '0')
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\flagbit\sevdesk\phpclient\Model\ModelObjectUsed',
                '/ObjectUsed'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\flagbit\sevdesk\phpclient\Model\ModelObjectUsed', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\flagbit\sevdesk\phpclient\Model\ModelObjectUsed', $e->getResponseHeaders());
