...
class LetterApi
{
     ...
     * @return \flagbit\sevdesk\phpclient\Model\ModelLetter
     */
     ...
     * @param string $body To create a letter, simply enter desired values after parameter&#x3D; and remove the quotation marks. (required)
     * @throws \flagbit\sevdesk\phpclient\ApiException on non-2xx response
     * @return array of \flagbit\sevdesk\phpclient\Model\ModelLetter, HTTP status code, HTTP response headers (array of strings)
     */
    public function addLetterWithHttpInfo($body)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\flagbit\sevdesk\phpclient\Model\ModelLetter',
                '/Letter'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\flagbit\sevdesk\phpclient\Model\ModelLetter', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 201:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\flagbit\sevdesk\phpclient\Model\ModelLetter', $e->getResponseHeaders());
