...
class SubscriptionTypeApi
{
     ...
     * @return \flagbit\sevdesk\phpclient\Model\ModelSubscriptionType
     */
     ...
     *
     * @throws \flagbit\sevdesk\phpclient\ApiException on non-2xx response
     * @return array of \flagbit\sevdesk\phpclient\Model\ModelSubscriptionType, HTTP status code, HTTP response headers (array of strings)
     */
    public function getSubscriptionTypesWithHttpInfo()
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\flagbit\sevdesk\phpclient\Model\ModelSubscriptionType',
                '/SubscriptionType'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\flagbit\sevdesk\phpclient\Model\ModelSubscriptionType', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\flagbit\sevdesk\phpclient\Model\ModelSubscriptionType', $e->getResponseHeaders());
